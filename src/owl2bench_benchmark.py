...
def run_owl2bench_benchmark(
    *,
    ...
    print(f"Oracles: {', '.join(oracle_backends)}")
    ...
    for engine_mode in modes:
        ...
        resolution_key = "query-like" if engine_mode in {"query", "filtered_query"} else engine_mode
        ...
        for backend in oracle_results:
            ...
            print(
                f"{backend.backend}: time={backend.elapsed_ms:.3f} ms, "
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        default=["query", "filtered_query", "stratified"],
    ...
    sameas_group.add_argument("--materialize-sameas", dest="materialize_sameas", action="store_true")
    sameas_group.add_argument("--no-materialize-sameas", dest="materialize_sameas", action="store_false")
    ...
    parser.add_argument(
        ...
        default="query",
        help="Oracle query mode for query and filtered_query engine modes.",
    )
    parser.add_argument(
